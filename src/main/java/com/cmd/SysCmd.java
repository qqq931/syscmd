...
public class SysCmd implements ModInitializer {
    ...
    // ===== 危险指令二次确认系统 =====
    // 存储待确认的操作：key=玩家UUID, value=待确认的操作信息
    ...
    private static class PendingConfirmation {
        final String command;       // 原始命令描述
        final Runnable action;      // 确认后执行的操作
